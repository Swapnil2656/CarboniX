...
import { ingest } from './methods/ingest.js';
import { compare } from './methods/compare.js';
import { recommend } from './methods/recommend.js';

// Re-export everything so consumers can use types directly
export type {
  CarbonixConfig,
  CloudProvider,
  CarbonRating,
