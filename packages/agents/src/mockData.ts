...
export interface MockInstance {
  ...
  networkOutGb: number;
  storageGb: number;
  hoursRunning: number;      // hours this month
}

// Realistic instance fleet that a mid-size Indian startup would run
const MOCK_FLEET: Omit<MockInstance, 'cpuUtilization' | 'memoryUtilization' | 'networkInGb' | 'networkOutGb'>[] = [
 ...
 */
const UTILIZATION_PROFILES: Record<string, { cpuRange: [number, number]; memRange: [number, number] }> = {
 ...
 */
export function generateMockInstances(): MockInstance[] {
