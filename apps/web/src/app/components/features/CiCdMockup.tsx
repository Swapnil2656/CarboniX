      ...
      <div className="border-b border-[#30363d] p-4 flex gap-3 items-start bg-[#161b22]">
        ...
        <div>
          <h3 className="text-white font-semibold text-base mb-1">
            ...
            <span className="text-[#b0b8c0] font-normal ml-2">#102</span>
          </h3>
          <p className="text-[#b0b8c0] text-xs">
            swapnil wants to merge 3 commits into <code className="bg-[#1f242c] px-1 rounded text-[#ffffff]">main</code>
          </p>
        </div>
      </div>
      ...
      <div className="p-4 space-y-3">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#ffffff] font-medium">ESLint / Prettier</span>
          </div>
          <span className="text-[#b0b8c0]">Successful in 12s</span>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            <CheckCircle className="text-[#238636] w-5 h-5" />
            <span className="text-[#ffffff] font-medium">Jest Unit Tests</span>
          </div>
          <span className="text-[#b0b8c0]">Successful in 1m 4s</span>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            {step >= 4 ? (
              ...
              <svg className="animate-spin h-5 w-5 text-[#b0b8c0]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
            )}
            <span className={`font-medium ${step >= 4 ? "text-[#da3633]" : "text-[#ffffff]"}`}>
              CarboniX GateAgent
            </span>
          </div>
          <span className={step >= 4 ? "text-[#da3633]" : "text-[#b0b8c0]"}>
        ...
        >
          <div className="absolute -top-3 left-4 bg-[#0d1117] px-1 text-xs font-semibold text-[#b0b8c0]">
            CarboniX (bot)
          </div>
          <div className="flex gap-3 text-[#ffffff] mt-2">
            ...
            <div>
              ...
              <p className="text-[#b0b8c0] mb-3 leading-relaxed">
                Deploying 5x <code className="bg-[#1f242c] border border-[#30363d] px-1 rounded text-[#ffffff]">p4d.24xlarge</code> instances in <code className="bg-[#1f242c] border border-[#30363d] px-1 rounded text-[#ffffff]">ap-south-1</code> (Mumbai) adds <strong className="text-[#da3633]">+142kg CO₂e/day</strong> to your baseline, exceeding your 100kg limit.
              </p>
              <div className="bg-[#161b22] border border-[#30363d] rounded p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <span className="text-[#b0b8c0] text-xs font-medium">Suggested Optimization:</span>
