...
-- CreateEnum
CREATE TYPE "AgentType" AS ENUM ('COLLECTOR', 'ANALYST', 'CICD_GATE', 'REPORTER');
...
CREATE TABLE "EmissionRecord" (
    ...
    "networkInGb" DOUBLE PRECISION,
    "networkOutGb" DOUBLE PRECISION,
...
CREATE TABLE "Project" (
    ...
    "name" TEXT NOT NULL,
    "region" TEXT,
    "sdkConnected" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "AgentRun_agentType_createdAt_idx" ON "AgentRun"("agentType", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "AgentRun_status_idx" ON "AgentRun"("status");

-- CreateIndex
CREATE INDEX "EmissionRecord_region_timestamp_idx" ON "EmissionRecord"("region", "timestamp" DESC);

-- CreateIndex
CREATE INDEX "EmissionRecord_isIdle_idx" ON "EmissionRecord"("isIdle");

-- CreateIndex
CREATE INDEX "EmissionRecord_isOversized_idx" ON "EmissionRecord"("isOversized");

-- CreateIndex
CREATE INDEX "EmissionRecord_agentRunId_idx" ON "EmissionRecord"("agentRunId");
